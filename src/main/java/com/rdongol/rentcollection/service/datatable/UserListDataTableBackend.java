...
public class UserListDataTableBackend extends AbstractDataTableBackend {
	...
	protected String getEditUserAction(String userId) {
		...
		editUser.append("<i class='actionButton editUser fas fa-edit fa-lg' userId='"+userId+"' title='edit' style = 'color:#3559BA'> </i>");
	...
	protected String getDeleteUserAction(String userId) {
		...
		deleteUser.append("<i class='actionButton deleteUser fas fa-trash-alt fa-lg' userId='"+userId+"' title='disable' style = 'color:#FF686B'></i>");
